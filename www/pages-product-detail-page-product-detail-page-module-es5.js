...
var ProductDetailPagePage = /** @class */ (function () {
    function ProductDetailPagePage(route, router, toastController) {
        var _this = this;
        this.route = route;
        this.router = router;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params && params.special) {
                ...
                _this.fromCart = params.fromCart;
            }
        });
        var data = [];
    ...
    ProductDetailPagePage.prototype.ionViewWillEnter = function () {
    ...
    ProductDetailPagePage.prototype.sendToInvoicePage = function () {
    ...
    ProductDetailPagePage.prototype.presentToast = function () {

...
var InvoicePagePage = /** @class */ (function () {
    function InvoicePagePage(router, route, alertController) {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            if (params && params.single) {
                _this.oneItem = JSON.parse(params.single);
            }
        });
    }
    ...
    InvoicePagePage.prototype.ionViewWillEnter = function () {
    ...
    InvoicePagePage.prototype.singleItem = function () {
        var _this = this;
        this.cartItems = [];
        // console.log('this.one', this.oneItem);
    ...
    InvoicePagePage.prototype.cartitem = function () {
        var _this = this;
